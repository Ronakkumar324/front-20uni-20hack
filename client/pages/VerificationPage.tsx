...
export default function VerificationPage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const results = mockVerificationResults[searchAddress as keyof typeof mockVerificationResults] || [];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-cyan-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <Badge variant="secondary" className="ml-2">Verify</Badge>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Verify Credentials</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Instantly verify the authenticity of academic credentials and achievements 
            stored on the Aptos blockchain.
          </p>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Enter a wallet address or scan a QR code to view and verify credentials.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {hasSearched && (
              <Alert>
                ...
                <AlertDescription>
                  Search completed. {searchResults.length} credential(s) found for address: {searchAddress}
                </AlertDescription>
              </Alert>
            )}
          </CardContent>
                    ...
                    <CardContent>
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span className="font-semibold text-green-800">Credential Verified</span>
                        </div>
                        <p className="text-sm text-green-700">
                          This credential has been verified on the Aptos blockchain and is authentic.
                        </p>
                        <div className="mt-2 flex items-center space-x-4 text-xs text-green-600">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => copyToClipboard(credential.onChainAddress)}
                          >
          ...
          <div className="mt-12">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Understanding the verification process for blockchain-based credentials
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Enter a wallet address or scan a QR code to look up credentials
                    </p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Check the Aptos blockchain to confirm credential authenticity
                    </p>
                  </div>
