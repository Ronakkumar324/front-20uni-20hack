        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <Badge variant="secondary" className="ml-2">Aptos</Badge>
            </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              ...
              permanently verifiable academic credentials. Certificates, course completions, 
              and achievements that follow you everywhere.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Leveraging blockchain technology to ensure your credentials are secure, 
              verifiable, and yours forever.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-2 hover:border-primary/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Non-transferable NFTs that are permanently bound to your wallet, 
            ...
            <Card className="border-2 hover:border-primary/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Anyone can verify your credentials instantly using your wallet address 
            ...
            <Card className="border-2 hover:border-primary/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Only verified institutions and organizations can mint credentials, 
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="bg-credential-500/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-bold text-credential-600">2</span>
              </div>
          ...
          <Card className="border-2 border-primary/20 bg-gradient-to-r from-primary/5 to-credential-500/5">
            <CardContent className="pt-8">
              ...
              <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                Join thousands of students and institutions using CredVault to issue, 
                store, and verify academic achievements on the blockchain.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-primary hover:bg-primary/90" asChild>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 mb-4">
                Secure, verifiable academic credentials powered by Aptos blockchain technology.
              </p>
              <div className="flex items-center space-x-2">
                <CheckCircle className="h-4 w-4 text-credential-500" />
                <span className="text-sm text-gray-600">Deployed on Aptos Testnet</span>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link to="/student" className="hover:text-primary">Student Dashboard</Link></li>
                <li><Link to="/issuer" className="hover:text-primary">Issuer Portal</Link></li>
                <li><Link to="/verify" className="hover:text-primary">Verify Credentials</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li><a href="#" className="hover:text-primary">Smart Contract</a></li>
